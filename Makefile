...
.PHONY: windows
freebsd:
	g++46 -g -DNO_MALLOC_H -o main main.cpp Player.cpp Timer.cpp World.cpp utils.cpp Rectangle.cpp -I/usr/local/include/SDL -lSDL -lSDL_image -lSDL_mixer -lm -lstdc++
.PHONY: all
